...
namespace OpcPublisher
{
    ...
    public class PublisherNodeConfiguration : IPublisherNodeConfiguration, IDisposable
    {
        ...
        /// </summary>
        public static string PublisherNodeConfigurationFilename { get; set; } = $"{Path.DirectorySeparatorChar}configuration{Path.DirectorySeparatorChar}publishednodes.json";
